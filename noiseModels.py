...
def plot_OU(t_max = 1000, A0 = 1, decay_factor = 1, output_size = 1, mu = 0.0, theta = 0.15, sigma = 0.20, seed = 0):
    ...
    OU = OUNoise(output_size, mu, theta, sigma, seed) # Ornstein–Uhlenbeck Process
    t = list(range(t_max))
    x = []
    A = A0 # scaling factor
    for _ in t:
